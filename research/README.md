...
```text
datasets/       local raw, cleaned, masked, and challenge corpora
docs/           research plan, numbered reports, and literature notes
generated/      derived corpora and frozen experimental evidence
...
links the dataset report, authorship-meter report, five numbered transfer
iterations, and literature notes. Use
[`workflows/README.md`](workflows/README.md) for current commands and
[`experiments/README.md`](experiments/README.md) to audit an older iteration.
...
Heavy rebuilds are explicit: `make rebuild-corpus`, `make audit-masks`, and
`make benchmark-authorship`. They are not part of the quick verification target.
