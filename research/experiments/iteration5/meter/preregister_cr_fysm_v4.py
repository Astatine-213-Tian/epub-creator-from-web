...
from experiments.iteration5.meter.build_cr_fysm_v4 import CANONICAL_PREREGISTRATION
...
def main() -> None:
    ...
    payload: dict[str, Any] = {
        ...
        "run_command": "uv run python -m experiments.iteration5.meter.build_cr_fysm_v4",
    }
