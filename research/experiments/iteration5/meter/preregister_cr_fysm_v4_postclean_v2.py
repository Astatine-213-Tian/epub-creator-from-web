...
from experiments.iteration5.meter.build_cr_fysm_v3 import canonical_lock_id, runtime_versions, sha256_file
from experiments.iteration5.meter.build_cr_fysm_v4 import qualification_records
from experiments.iteration5.meter.preregister_cr_fysm_v4_postclean import (
    OLD_PREREGISTRATION,
    OLD_RESULTS,
    PATHS as BASE_PATHS,
    read_json,
...
RETIRED_BOOKS = {("妄鸦", "晚来天欲雪"), ("妄鸦", "能饮一杯无")}
PROMOTED_BOOKS = {("妄鸦", "无限练习生"), ("妄鸦", "悬疑片导演")}
DEPENDENCY_PATHS = {
    "preregister_v1_helper": Path(__file__).with_name("preregister_cr_fysm_v4_postclean.py"),
...
def main() -> None:
    ...
    if len(manifest) != 199 or len(author_counts) != 50 or min(author_counts.values()) < 3:
    ...
    payload: dict[str, Any] = {
        ...
        "run_command": "uv run python -m experiments.iteration5.meter.rescore_cr_fysm_v4_postclean_v2",
    }
