...
from experiments.iteration5.construct import prepare_cr_fysm_v4_style_positive_block_amendment_v1 as block_v1
from experiments.iteration5.construct import prepare_cr_fysm_v4_style_positive_stitch_amendment_v2 as stitch_v2
...
def main() -> None:
    ...
    payload: dict[str, Any] = {
        ...
        "root_cause": {
            "file": "experiments/iteration5/construct/run_cr_fysm_v4_style_positive_stitch_amendment_v2.py",
            "file_sha256": generation.sha256_file(
                Path("experiments/iteration5/construct/run_cr_fysm_v4_style_positive_stitch_amendment_v2.py")
            ),
            "defect": (
        ...
        "verification_command": (
            "uv run python -m experiments.iteration5.construct.run_cr_fysm_v4_construct_generation "
