...
from experiments.iteration5.construct import prepare_cr_fysm_v4_construct_analysis_v2 as prepare
...
from experiments.iteration5.meter.develop_cr_fysm_v4 import load_family_artifacts
...
def main() -> None:
    ...
    lines.extend(
        [
            ...
            "quality, causal style dimensions, unseen-author generalization, or LoRA efficacy.",
        ]
    )
    REPORT.write_text("\n".join(lines) + "\n", encoding="utf-8")
