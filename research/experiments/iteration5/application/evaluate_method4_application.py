...
from experiments.iteration5.application import (  # noqa: E402
...
def write_markdown(path: Path, report: dict[str, Any]) -> None:
    ...
    lines = [
        ...
        "> was the strongest Iteration-5 prompt arm at 6/8 joint successes, but it did not",
        "> reach the registered 80% research endpoint. The historical n-gram scorer below",
    ...
    lines.extend(
        ...
        "`MANIFEST_ONLY`, not a per-segment implementation claim.",
            ...
            "",
            "```bash",
            "uv run python experiments/iteration5/application/evaluate_method4_application.py \\",
