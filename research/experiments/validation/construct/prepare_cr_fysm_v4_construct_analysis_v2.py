...
AMENDMENT_RUNNER = Path(
    "experiments/validation/construct/run_cr_fysm_v4_english_source_amendment_v1.py"
)
...
ADJUDICATION_AMENDMENT_RUNNER = Path(
    "experiments/validation/construct/run_cr_fysm_v4_english_adjudication_amendment_v1.py"
)
...
STYLE_POSITIVE_AMENDMENT_PREPARER = Path(
    "experiments/validation/construct/prepare_cr_fysm_v4_style_positive_block_amendment_v1.py"
)
STYLE_POSITIVE_AMENDMENT_RUNNER = Path(
    "experiments/validation/construct/run_cr_fysm_v4_style_positive_block_amendment_v1.py"
)
STYLE_POSITIVE_AMENDMENT_REVISION = Path(
    "experiments/validation/construct/revise_cr_fysm_v4_style_positive_block_amendment_v1.py"
)
...
STYLE_POSITIVE_STITCH_PREPARER = Path(
    "experiments/validation/construct/prepare_cr_fysm_v4_style_positive_stitch_amendment_v2.py"
)
STYLE_POSITIVE_STITCH_RUNNER = Path(
    "experiments/validation/construct/run_cr_fysm_v4_style_positive_stitch_amendment_v2.py"
)
...
STYLE_POSITIVE_INCIDENT_RECORDER = Path(
    "experiments/validation/construct/record_cr_fysm_v4_style_positive_incident_v1.py"
)
STYLE_POSITIVE_INCIDENT_AUDIT = (
    STYLE_POSITIVE_INCIDENT_ROOT / "independent_audit_preclosure.md"
)
ASSET_DIR = Path("experiments/validation/construct/assets")
...
RATING_RUNNER = Path("experiments/validation/construct/run_cr_fysm_v4_construct_ratings_v2.py")
SCORING_RUNNER = Path("experiments/validation/construct/analyze_cr_fysm_v4_construct_v2.py")
...
def fixed_input_paths() -> list[Path]:
    ...
    return [
        ...
        RATING_RUNNER,
        SCORING_RUNNER,
        Path("experiments/validation/construct/run_cr_fysm_v4_construct_generation.py"),
        Path("experiments/validation/construct/construct_v2_protocol.py"),
        Path("experiments/iteration4/prepare.py"),
        Path("experiments/validation/meter/benchmark_content_resistant_meter.py"),
...
def main() -> None:
    ...
    payload: dict[str, Any] = {
        ...
        "commands": {
            "semantic": "uv run python -m experiments.validation.construct.run_cr_fysm_v4_construct_ratings_v2 semantic --jobs 4",
            "style": "uv run python -m experiments.validation.construct.run_cr_fysm_v4_construct_ratings_v2 style --jobs 4",
            "adjudicate": "uv run python -m experiments.validation.construct.run_cr_fysm_v4_construct_ratings_v2 adjudicate --jobs 4",
            "analyze": "uv run python -m experiments.validation.construct.analyze_cr_fysm_v4_construct_v2",
            "analyze_recover_after_implementation_failure_only": "uv run python -m experiments.validation.construct.analyze_cr_fysm_v4_construct_v2 --resume-opened",
        },
    }
