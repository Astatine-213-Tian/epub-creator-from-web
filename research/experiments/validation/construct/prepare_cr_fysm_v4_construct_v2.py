...
RUNNER = Path("experiments/validation/construct/run_cr_fysm_v4_construct_generation.py")
CLOSURE = Path("experiments/validation/construct/close_cr_fysm_v4_construct_generation.py")
REGRESSION_TEST = Path(
    "tests/experiments/validation/test_cr_fysm_v4_construct_v2.py"
)
POSTCLEAN_ROOT = Path(
    "generated/style_research/style_transfer_experiments/iterations/"
...
def fixed_paths() -> list[Path]:
    return [
        ...
        Path("experiments/validation/meter/preregister_cr_fysm_v4_postclean_v2.py"),
        Path("experiments/validation/meter/rescore_cr_fysm_v4_postclean_v2.py"),
