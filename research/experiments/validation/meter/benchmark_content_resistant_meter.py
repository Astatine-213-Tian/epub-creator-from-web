...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Benchmark content-resistant author-style meters after transfer studies."
    )
    parser.add_argument(
        "--masked-dataset",
        type=Path,
...
def main() -> None:
    ...
    result_payload = {
        ...
        "selection_rule": {
            ...
            "note": "Legacy generated pairs are method-development diagnostics, not a fresh efficacy cohort.",
        },
    ...
    lines = [
        "# Content-Resistant Meter Validation",
        "",
    ...
    lines.extend(
        [
            ...
            "prefers original target prose over its neutral back-translation. Any future",
            "transfer study requires a fresh generated-domain calibration cohort.",
            "",
            "## Reproduction",
            "",
            "```bash",
            "uv run python -m experiments.validation.meter.benchmark_content_resistant_meter",
            "```",
        ]
    )
