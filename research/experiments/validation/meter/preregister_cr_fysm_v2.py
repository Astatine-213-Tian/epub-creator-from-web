...
from experiments.validation.meter.benchmark_content_resistant_meter import TARGET_AUTHOR, read_jsonl
from experiments.validation.meter.build_cr_fysm_v2 import FAMILY_ORDER, SEED, stable_order
...
def main() -> None:
    ...
    payload: dict[str, Any] = {
        ...
        "purpose": (
            ...
            "future style-transfer candidate generation."
        ),
        "v1_disposition": {
        ...
        "feature_contract": {
            ...
            "forbidden": [
                ...
                "observed transfer outputs as fitting data",
            ],
        ...
        "run_command": "uv run python -m experiments.validation.meter.build_cr_fysm_v2",
    }
