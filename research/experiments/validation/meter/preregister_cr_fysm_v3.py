...
PATHS = {
    ...
    "preregistration_script": Path("experiments/validation/meter/preregister_cr_fysm_v3.py"),
...
def main() -> None:
    ...
    payload: dict[str, Any] = {
        ...
        "purpose": (
            ...
            "future style-transfer generation."
        ),
        "prior_attempts": {
        ...
        "run_command": "uv run python -m experiments.validation.meter.build_cr_fysm_v3",
    }
